<section class="car-booking mt-5">
    <div class="container">
    <form class="shadow p-5">
        <h2 class="pb-3 ">Book a car</h2>
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="form-group">
                    <label for="plan">Package Type</label>
                    <select name="package" id="plan" class="form-control">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="form-group">
                    <label for="Drop-up"><i class="fa-solid fa-location-dot"></i>Drop-up</label>
            ...
            <button type="submit" class="myBtn align-right border-0" onclick="gotowhatsapp()">Submit</button>
            </div>
        </div><!--row-->
	</form>
    </div>
